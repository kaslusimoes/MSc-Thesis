...
Inserting back into Bayes' rule, we obtain the posterior $\tilde{\beta} |\{h_i\}_{i \in \mathit{pa}} \sim \mathrm{Gamma} \left(k_0+2n, \frac{\theta_0}{1+\theta_0(n-m)} \right)$. Explicitly:
